...
namespace Familestan.Migrations
{
    ...
    [Migration("20250316230450_FixOtpVerification")]
    partial class FixOtpVerification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Familestan.Core.Entities.OtpVerification", b =>
                {
                    ...
                    b.Property<long?>("OtpMemberId")
                        .HasColumnType("bigint");

                    b.Property<string>("OtpTarget")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Familestan.Core.Entities.OtpVerification", b =>
                {
                    b.HasOne("Familestan.Core.Entities.Member", "OtpMember")
                        .WithMany()
                        .HasForeignKey("OtpMemberId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("OtpMember");
                });
